...
console.log('🔍 DEBUG HomeView:');
console.log('  - paidEnrollments:', paidEnrollments.length);
paidEnrollments.forEach(e => {
  console.log(`    - ${e.certificates?.title}: amount_paid=${e.amount_paid}, type=${typeof e.amount_paid}`);
});
console.log('  - totalInvested calculé:', totalInvested);
console.log('  - totalInvested formaté:', totalInvested > 0 ? `${totalInvested.toLocaleString()} FCFA` : '—');
  return (
      ...
      {paidEnrollments.length > 0 && (
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-slate-500 bg-[#0f172a] px-2 py-0.5 rounded-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-amber-300">
                  Débloquez vos formations maintenant
                </p>
      ...
      {enrollments.length === 0 && (
        ...
        >
          ...
          <p className="text-sm text-slate-400 mb-6">
            Ajoutez une formation pour débloquer votre avenir juridique
          </p>
        </motion.div>
      )}
    </div>
