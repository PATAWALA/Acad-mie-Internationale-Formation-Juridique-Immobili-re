...
const navItems = [
  ...
  { href: '/dashboard/admin/paiements', label: 'Paiements', icon: CreditCard }, // ← AJOUTÉ
...
export default function AdminSidebar() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between p-5 border-b border-slate-800 flex-shrink-0 h-[73px]">
        {!collapsed && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
