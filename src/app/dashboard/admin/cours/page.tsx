      ...
      >
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Gérez les cours, les certificats associés et les enseignants responsables
          </p>
        </div>
      ...
      >
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Aucun cours</h3>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {course.certificate?.title ? (
                          ...
                          <span className="text-slate-600 text-sm">Non défini</span>
                        )}
                      </td>
                      <td className="px-6 py-4">
                        {course.teacher?.full_name ? (
                          <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-full bg-violet-500/20 flex items-center justify-center">
                              <span className="text-[10px] font-bold text-violet-300">
                                {course.teacher.full_name[0].toUpperCase()}
                              </span>
                            </div>
                          ...
                          <span className="text-slate-600 text-sm">Non assigné</span>
                        )}
                      </td>
        ...
        {showDeleteConfirm && (
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 text-sm mb-6">
                Cette action est irréversible. Le cours et tous ses modules seront définitivement
                supprimés.
              </p>
